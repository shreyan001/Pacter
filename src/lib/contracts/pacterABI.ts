...
/**
 * PacterEscrowV2 Contract ABI and Type Definitions
 * 
 * This file contains the complete ABI for the PacterEscrowV2 smart contract
 * deployed on the 0G blockchain, along with TypeScript type definitions.
 */

export const PACTER_ABI = [
  {
    type: 'constructor',
    inputs: [
    ...
    outputs: [
      {
        name: '',
        type: 'tuple',
        internalType: 'struct PacterEscrowV2.Order',
        components: [
          { name: 'orderHash', type: 'bytes32', internalType: 'bytes32' },
          ...
          { name: 'storageFee', type: 'uint256', internalType: 'uint256' },
          { name: 'projectName', type: 'string', internalType: 'string' },
          { name: 'currentState', type: 'uint8', internalType: 'enum PacterEscrowV2.OrderState' },
  ...
  },
  {
    ...
    inputs: [
      { name: 'orderHash', type: 'bytes32', indexed: true, internalType: 'bytes32' },
      { name: 'newState', type: 'uint8', indexed: false, internalType: 'enum PacterEscrowV2.OrderState' },
    ],
    anonymous: false,
  },
  {
